...
describe("Permission Plugin - Integration", function () {
    ...
    it("should create new entity", function () {
        expect(function () {
            entity = index_1.Tent.Entity("UserPermission", {
                name: String,
                email: String,
                password: String,
                active: Boolean,
            ...
            entity.install(new permission_1.Permission());
            var auth = entity.plugins.auth;
            var perm = entity.plugins.permission;
            perm.create(["super"]);
            perm.update("super");
            perm.read("super");
            perm.list("super");
    ...
    describe("CURLD Requests with no auth", function () {
        ...
        describe("DELETE Request", function () {
            it("should return proper value", function (done) {
                var _this = this;
                chai.request(index_1.Tent.app())["delete"]("/api/userpermissions/" + _id)
                    .send()
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!collection)
                                return [2 /*return*/];
                            return [4 /*yield*/, collection.find({}).exec()];
                        case 1:
                            _id = (_a.sent())[0]._id;
                            return [2 /*return*/];
                    }
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                if (!collection)
                                    return [2 /*return*/];
                                return [4 /*yield*/, collection.updateMany({}, { $set: { active: true, roles: ["super"] } })];
                            case 1:
                                _a.sent();
                                return [2 /*return*/];
                        }
